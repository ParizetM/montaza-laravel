...
<?php $component->withAttributes([]); ?>
    ...
    <noscript>
        <div class="mb-4 text-red-600 bg-orange-100 border-l-4 border-orange-500 dark:text-red-100 dark:bg-red-700 dark:border-red-600 p-4" role="alert">
            <?php echo e(__('JavaScript est requis pour se connecter. Veuillez activer JavaScript dans les paramètres de votre navigateur et réessayer.')); ?>
...
<?php endif; ?>
<?php /**PATH /home/vagrant/code/montaza/resources/views/auth/login.blade.php ENDPATH**/ ?>