...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['slot_item', 'slot_tooltip', 'position' => 'auto', 'class' => '']));
...
foreach (array_filter((['slot_item', 'slot_tooltip', 'position' => 'auto', 'class' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="tooltip('<?php echo e($position); ?>')"
     x-init="init()"
     class="relative inline-block <?php echo e($class); ?>"
...
<?php /**PATH /home/vagrant/code/montaza/resources/views/components/tooltip.blade.php ENDPATH**/ ?>