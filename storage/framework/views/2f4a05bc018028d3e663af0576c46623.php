<div class="bg-white dark:bg-gray-800 flex flex-col h-full rounded-xl overflow-hidden shadow-lg border border-purple-100 dark:border-purple-900/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
    ...
    <div class="px-3 py-2 border-b border-purple-100 dark:border-purple-900/50 flex justify-between items-center bg-purple-600 dark:bg-purple-900/20">
        <div class="flex items-center gap-2">
            ...
            <h2 class="font-bold text-sm text-white dark:text-purple-100">
                <a href="<?php echo e(route('affaires.index')); ?>" class="hover:underline transition"><?php echo e(__('Affaires')); ?></a>
            </h2>
        </div>
        <a href="<?php echo e(route('affaires.index')); ?>" class="text-[10px] font-bold text-purple-100 hover:text-white dark:text-purple-400 dark:hover:text-purple-300 transition-colors uppercase tracking-wider">
            Voir tout
        </a>
    </div>
    ...
    <div class="flex-1 overflow-y-auto p-2 scrollbar-thin scrollbar-thumb-purple-200 dark:scrollbar-thumb-purple-800">
        <?php if($affaires->count() > 0): ?>
            <div class="space-y-1">
                <?php $__currentLoopData = $affaires->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $affaire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-2 hover:bg-purple-100 dark:hover:bg-purple-900/20 rounded-md transition-all duration-300 hover:scale-[1.03] hover:shadow-lg group cursor-pointer border border-transparent hover:border-purple-200 dark:hover:border-purple-800/30" onclick="window.location='<?php echo e(route('affaires.show', $affaire)); ?>'">
                        <div class="flex justify-between items-start mb-0.5">
                            ...
                            <?php if(isset($affaire->created_at)): ?>
                            <span class="text-[9px] text-gray-400 font-mono">
                                <?php echo e($affaire->created_at->format('d/m')); ?>
                        ...
                        <div class="flex items-center justify-between">
                             <div class="flex items-center gap-1.5">
                                <span class="h-1.5 w-1.5 rounded-full ring-1 ring-white dark:ring-gray-800"
                                      style="background-color: <?php echo e($affaire->statut_color ?? '#9ca3af'); ?>"></span>
                                <span class="text-[9px] uppercase font-bold tracking-wider text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300">
                                    <?php echo e($affaire->statut_label ?? 'N/A'); ?>
...
<?php /**PATH /home/vagrant/code/montaza/resources/views/affaires/index_col.blade.php ENDPATH**/ ?>