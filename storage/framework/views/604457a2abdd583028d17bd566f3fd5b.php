                ...
                <div class="flex items-center gap-2">
                    ...
                    <?php if (Auth::check() && Auth::user()->hasPermission('gerer_les_affaires')): ?>
                        <a href="<?php echo e(route('affaires.create')); ?>" class="group inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-colors duration-200 shadow-sm whitespace-nowrap">
                            ...
                            <?php echo e(__('Nouvelle affaire')); ?>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100 dark:border-gray-700 h-full flex flex-col">
                                ...
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-2 mb-2">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-bold uppercase tracking-wide bg-<?php echo e($affaire->statut_color); ?>-100 text-<?php echo e($affaire->statut_color); ?>-700 dark:bg-<?php echo e($affaire->statut_color); ?>-900/50 dark:text-<?php echo e($affaire->statut_color); ?>-300">
                                                <?php echo e($affaire->statut_label); ?>

                                            </span>
                                            <span class="text-xs text-gray-400 font-mono"><?php echo e($affaire->code); ?></span>
                                        </div>
                            ...
                            <div class="p-5 flex-1 flex flex-col justify-end space-y-4">
                                <div class="space-y-2">
                                    <div class="flex justify-between items-center text-sm">
                                        ...
                                        <span class="font-bold text-gray-900 dark:text-gray-100"><?php echo e(number_format($affaire->budget, 0, ',', ' ')); ?> €</span>
                                    </div>
                                    ...
                                    <div class="relative pt-1">
                                        <div class="overflow-hidden h-1.5 mb-1 text-xs flex rounded bg-gray-100 dark:bg-gray-700">
                                            ...
                                            ?>
                                            <div style="width:<?php echo e($percentage); ?>%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center <?php echo e($barColor); ?>"></div>
                                        </div>
                                        <div class="flex justify-between items-center text-xs">
                                             <span class="text-gray-400">Consommé</span>
                                            <span class="font-bold <?php echo e($affaire->total_ht > $affaire->budget ? 'text-red-600' : 'text-green-600'); ?>">
                                                <?php echo e(number_format($affaire->total_ht, 0, ',', ' ')); ?> €
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="px-5 py-3 bg-gray-50 dark:bg-gray-700/30 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center text-xs font-medium text-gray-500 dark:text-gray-400">
                                ...
                                <div class="flex items-center gap-1" title="Matériels">
                                    ...
                                    <?php echo e($affaire->materiels->where('pivot.statut', '!=', 'termine')->count()); ?>
