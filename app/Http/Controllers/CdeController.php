...
class CdeController extends Controller
{
    ...
    public function sendMails(Request $request, $id)
    {
        ...
        try {
            \App\Services\UserMailer::forUser($currentUser)->send([], [], function ($message) use ($request, $primaryContact, $ccContacts, $pdfPath, $signaturePath, &$contenu, $senderEmail, $senderName) {
