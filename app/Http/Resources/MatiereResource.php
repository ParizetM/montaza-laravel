...
class MatiereResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        $data = [
            ...
            'longueur' => $this->longueur ?? null,
            'prix' => $this->prix ?? null,
            'prix_formated' => $this->prix !== null ? number_format($this->prix, 2, ',', '\u202f') . '\u00a0€' : null,
            'Unite' => $this->unite->short ?? null,
            'Unite_id' => $this->unite->id ?? null,
            'Unite_full' => $unite_full,
            'fournisseur' => $this->whenLoaded('fournisseurs', fn() => $this->fournisseurs->first()?->raison_sociale),
            'fournisseurs_count' => $this->whenLoaded('fournisseurs', fn() => $this->fournisseurs->count(), 0),
