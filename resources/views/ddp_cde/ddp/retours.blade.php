    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const hot = new Handsontable(container, {
                            ...
                            cells: function(row, col, prop) {
                                ...
                                cellProperties.renderer = function(instance, td, row, col, prop, value) {
                                        ...
                                        if (col % 4 === 1) {
                                            ...
                                            if (value == minValue) {
                                                if (isDarkMode) {
                                                    td.style.backgroundColor = '#145214'; // Vert foncé pour dark mode
                                                    td.style.color = '#77DD77'; // Vert clair pour dark mode
                                                } else {
                                                    td.style.backgroundColor = '#77DD77'; // Vert clair pour light mode
                                        ...
                                        if (col % 4 === 3) {
                                            const minValue = findMinValueDate(rowData); // Trouver la valeur minimale
                                            if (isDarkMode) {
                                                    td.style.backgroundColor = '#145214'; // Vert foncé pour dark mode
                                                    td.style.color = '#77DD77'; // Vert clair pour dark mode
                                                } else {
                        ...
                        const debouncedSaveChanges = debounce(saveChanges, 500); hot.addHook('afterChange', function(
                            changes, source) {
                            try {
                        ...
                        const button = document.querySelector('#refresh'); button.addEventListener('click', () => {
                            saveChanges();
                        });
