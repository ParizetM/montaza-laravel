<x-modal name="{{ $name ?? 'contacts-modal' }}" focusable maxWidth="6xl">
    <div class="bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 rounded-2xl">
        ...
        <div
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Contacts - {{ $contacts->first()->etablissement->nom }} <small class="text-gray-600 dark:text-gray-300 text-xs">{{ $contacts->first()->etablissement->societe->raison_sociale }}</small></h2>
