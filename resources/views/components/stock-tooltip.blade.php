@if ($matiere->typeAffichageStock() == 2)
    <div class="relative inline-block group">
        ...
        <div
            class="absolute invisible opacity-0 group-hover:visible group-hover:opacity-100 bottom-full left-1/2 -translate-x-1/2 mb-3 w-fit transition-all duration-300 ease-out transform group-hover:translate-y-0 translate-y-2 z-100">
            <div
            ...
            dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200">
                ...
                <ul class="text-sm space-y-1">
                    @foreach ($matiere->stock as $stock)
                        <li>- {{ $stock->quantite }} x {{ $stock->valeur_unitaire }} {{ $stock->unite->short }}</li>
                    @endforeach
                </ul>
